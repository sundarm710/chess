  ...
  return (
    <div className="pointer-events-none fixed right-0 top-0 z-40 h-full">
      ...
      <button
        ...
        style={{ transform: open ? `translateX(-${WIDTH}px)` : 'translateX(0)', writingMode: 'vertical-rl' }}
      >
      ...
      <aside
        ...
        onMouseLeave={() => setHover(false)}
        style={{ width: WIDTH }}
        className={`absolute right-0 top-0 h-full space-y-4 overflow-y-auto border-l border-line bg-paper p-3 shadow-xl transition-transform duration-200 ${
