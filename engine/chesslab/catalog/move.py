...
def move_features() -> List[AssemblyFeature]:
    ...
    return [
        ...
        _f(
            ...
            inputs="P/M", output_type="scalar", viz="trend", higher="neutral",
        ...
        _f(
            ...
            inputs="M", output_type="scalar", viz="trend", higher="neutral",
        ...
        _f(
            ...
            inputs="K", output_type="scalar", viz="trend", higher="neutral",
        ...
        _f(
            id="TIM.clock", name="Clock remaining", tier="T4", category="TIM",
            inputs="K", output_type="scalar", viz="trend", higher="neutral",
            requires=frozenset({Capability.CLOCK}),
            description="Each side's remaining time on the clock.",
            computation="The %clk after the side's last move, in seconds.",
            saturation="~2700",
        ),
        _f(
